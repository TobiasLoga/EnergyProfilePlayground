...
## 2024-07-12 Non-blocking operations habe ich nicht zum Laufen gebracht 
# Mit der Liste von dataframes als Ergebnis hat es nicht funktioniert. 
# Die Berechnung schien zwar zu gehen, aber ich konnte die Ergebnisse nicht ausgeben,
# es gab immer Fehlermeldungen
# 
# # Example for non-blocking operations
# # Source: https://shiny.posit.co/r/articles/improve/nonblocking/
# library (shiny)
# library (bslib)
# library (future)
# library (promises)
...
#   
# 
#   input_task_button("Do_CalculateStack", "Processs calculation stack"),
#   
#                     fluidRow (
# 
#                       column (
...
#                           label = NULL,
#                           # label   = "Jahr",
#                           choices = MobasyBuildingData::Data_Output$ID_Dataset ,
#                           #choices = c (1995:2023),
#                           selected = "Example.01",
#                           width = 500
#                         ),
...
#         MobasyBuildingDataTables = MobasyBuildingDataTables () )
#     })
#   }) |> bind_task_button ("Do_CalculateStack")
#   
#   
#   
#   
